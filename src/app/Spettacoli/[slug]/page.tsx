...
export default function SpettacoloDettaglio() {
  const params = useParams();
  const slug = params.slug;
  
  const show = content.pages.spettacoli.archive_sections.find(s => s.slug === slug);
